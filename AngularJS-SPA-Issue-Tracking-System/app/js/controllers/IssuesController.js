...
issueTracker.controller('IssuesController', function ($scope, $routeParams, $location, authentication,
                                                      projectsService, notifyService, issueServices, pageSize) {
    $scope.projectParams = {
        'startPage': 1,
        'pageSize': pageSize
    };
    ...
    $scope.getUserIssues = function () {
        issueServices.getUserIssues($scope.projectParams,
    ...
    $scope.changeStatus = function (issueId, statusId, statusName) {
        issueServices.changeIssueStatus(issueId, statusId,
            function success(data) {
    ...
    $scope.getIssueComments = function () {
        issueServices.getCommentsById($routeParams.id,
            function success(data) {
    ...
    $scope.addComment = function (issueId, comment) {
        issueServices.addCommentToIssue(issueId, comment,
            function success(data) {
